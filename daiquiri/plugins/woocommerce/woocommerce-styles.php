...
if ( !function_exists( 'daiquiri_woocommerce_get_css' ) ) {
	add_filter( 'daiquiri_filter_get_css', 'daiquiri_woocommerce_get_css', 10, 4 );
	function daiquiri_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Shop mode selector */
.daiquiri_shop_mode_buttons a {
	color: {$colors['text_link']};
}
.daiquiri_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .daiquiri_shop_mode_buttons a.woocommerce_thumbs,
.shop_mode_list .daiquiri_shop_mode_buttons a.woocommerce_list {
	color: {$colors['text']};
}
