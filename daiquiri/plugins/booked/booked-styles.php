...
if (!function_exists('daiquiri_booked_get_css')) {
	add_filter('daiquiri_filter_get_css', 'daiquiri_booked_get_css', 10, 4);
	function daiquiri_booked_get_css($css, $colors, $fonts, $scheme='') {
