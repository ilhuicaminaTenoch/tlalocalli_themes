...
if (!function_exists('daiquiri_trx_addons_get_css')) {
	add_filter('daiquiri_filter_get_css', 'daiquiri_trx_addons_get_css', 10, 4);
	function daiquiri_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_blogger_item .post_meta_item.post_date > a:before {
	color: {$colors['text_light']};
}
.sc_blogger_item .post_meta_item.post_date > a:hover {
	color: {$colors['text_link']};
}
...
.sc_icons_modern a.sc_icons_item_link:hover,
...
.sc_services_item.with_image.hover_video .post_featured.hover_icon .icons a.icon-link-1:hover {
	background-color:{$colors['text_link']};
	color: {$colors['text_dark']};
}
...
.sc_services_chess .sc_services_item_subtitle a {
	color:{$colors['inverse_bd_color']};
}
.sc_services_chess .sc_services_item_subtitle a:hover {
	color:{$colors['text_link']};
}
...
.sc_services_chess .sc_services_item_icon {
	border-color:{$colors['inverse_bd_color']} !important;
	background-color:{$colors['bg_color']};
}
...
.color_style_link2 .sc_item_subtitle .in {
	background-color: {$colors['inverse_link']};	
}

.color_style_dark .sc_item_subtitle .in {
	color: {$colors['inverse_link']};
	background-color: #7f6649;
}
.scheme_default.color_style_dark .sc_item_subtitle .in {
	background-color: #7f6649;	
}
