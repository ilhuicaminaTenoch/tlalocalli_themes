...
if ( !function_exists( 'daiquiri_vc_get_css' ) ) {
	add_filter( 'daiquiri_filter_get_css', 'daiquiri_vc_get_css', 10, 4 );
	function daiquiri_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.vc_toggle_default:hover .vc_toggle_title,
.vc_toggle_active.vc_toggle_default .vc_toggle_title {    
    background-color: {$colors['text_link']};
}
...
.vc_toggle_default:hover .vc_toggle_title > h4,
.vc_toggle_active.vc_toggle_default .vc_toggle_title > h4 {    
    color: {$colors['inverse_link']};
}
...
.vc_toggle_default:hover .vc_toggle_icon:after,
.vc_toggle_default:hover .vc_toggle_icon:before,
...
.vc_toggle_default:hover .vc_toggle_icon,
